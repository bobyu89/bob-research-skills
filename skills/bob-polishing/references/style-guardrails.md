...
- follow the target journal's spelling convention (American or British) and keep it consistent; check the author guide
- keep figure legends concise; a legend should let the figure stand alone without restating the Results paragraph
- keep titles short enough to be searchable; check the target journal's title length rule on its website (do not assume a number)
...
- keep statistical symbols and mathematical notation consistent; for APA 7 targets italicise statistical symbols (*p*, *t*, *F*, *M*, *SD*, *n*) and drop the leading zero for values that cannot exceed 1 (`p = .03`)
