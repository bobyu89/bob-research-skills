...
Load `../../../../bob-shared/core/results-discussion-escalation.md` when the
Results section reads as an inventory of analyses. Rebuild it as a claim
ladder: each subsection should advance the argument (a new comparison, a
boundary, a falsification) rather than replay the previous one.

For quantitative health research, report statistics in APA 7 form (see the
loaded `paper_type/*.md` fragment); for qualitative Results, keep theme,
supporting excerpt, and analytic commentary distinguishable.

Results writing should:

- load `../../../../bob-shared/core/main-text-discipline.md` and classify
