...
Default spelling follows the target journal. Most nursing, medical education,
and JMIR-family journals accept American spelling; several UK-based nursing
journals prefer British spelling. Check the author guide and stay consistent
within the manuscript. Never mix `randomised` and `randomized`.
