...
Introduction. Draft it last, when Results and Discussion are stable. For structured abstracts (Background / Aim / Design / Methods / Results / Conclusion, or the journal's own headings) and the evidence-chain rules, load `../../../../bob-shared/core/abstract-evidence-chain.md`.

## Default pattern (unstructured)
