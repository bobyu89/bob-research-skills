...
For health-science and nursing papers, load `../../../../bob-shared/core/introduction-funnel.md` (background -> importance -> gap -> aim). For a broad-audience summary paragraph (non-default), see `references/summary-paragraph-broad-audience.md`:
...
1. Establish the field stake. Make it land for a clinician or educator outside the immediate subfield.
...
- **task-then-application** (mainly for systems or algorithmic papers) — define a task abstractly, then show its applications
