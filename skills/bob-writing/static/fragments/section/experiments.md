# Section: Experiments (algorithmic or system evaluation, writing)

Use this fragment for baseline, ablation, benchmark, or model-evaluation results. For health-science Results (trials, surveys, qualitative themes, mixed-methods, DBR iterations) use `section/results.md` instead.
...
`../../../../bob-shared/core/results-discussion-escalation.md` for the three
archetypes and the same-level-repetition test.

## Drafting rules

- Load `../../../../bob-shared/core/main-text-discipline.md` before deciding
