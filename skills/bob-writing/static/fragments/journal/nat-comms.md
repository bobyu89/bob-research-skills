...
The shared layer does not carry a Nature Communications format file. Check the journal's current author instructions for word limits, abstract rules, figure specs, reference style, mandatory statements, and desk-rejection patterns, and record the verification date. Treat every number below as an example.
