...
For formatting, submission-package or readiness work, check the flagship
journal's current author instructions and record the verification date; the
shared layer does not carry a Nature format file.
...
`../../../../bob-shared/core/health-research-compliance.md`.
