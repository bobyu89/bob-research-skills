...
| Topic-comment opener (`關於X，…`) | Rewrite as subject-verb-object; make the topic the grammatical subject or drop it |
| Every sentence opening with `本文 / 我們` | Vary openings; lead some sentences with the result or the object, not the agent |
