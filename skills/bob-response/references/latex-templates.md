# LaTeX templates for revision correspondence (optional)

LaTeX is not the default output for this skill; most nursing and health-education journals
expect Word files, and `templates/response-letter.md` plus `templates/revision-cover-letter.md`
cover that path. Use this file only when the user asks for a LaTeX cover letter, LaTeX response-to-reviewers
