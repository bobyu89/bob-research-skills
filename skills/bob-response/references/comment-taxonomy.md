...
- For full data-availability, IRB, or consent wording, use `../bob-shared/core/health-research-compliance.md` when available and ask the author for the exact approval number and repository details.
