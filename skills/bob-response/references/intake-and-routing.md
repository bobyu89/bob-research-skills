...
the editorial decision before drafting strategy or prose. The gate does not apply to
`committee-response` mode; ask for the defense type (proposal or thesis) and the institute's
submission requirements instead. The gate does not apply to
`committee-response` mode; ask for the defense type (proposal or thesis) and the institute's
...
- If the user explicitly says 主要修訂、次要修訂、修改後再審、修改後刊登, major review, minor review,
  major revision, or minor revision, normalize it to the corresponding revision type
  (修改後再審 maps to Major Revision; 修改後刊登 and 修改後由主編決定 map to Minor Revision).
- If neither source resolves it, ask in the user's language and pause. Chinese default:
  「這是主要修訂（Major Revision）還是次要修訂（Minor Revision）？如果退修信沒有明確寫，請把退修信貼給我，我幫你判斷。」
...
| `revise` | User wants a draft rewritten for tone, traceability, or formal journal-style response | Existing draft plus target change request | Revised response text plus changed-risk notes |
...
| `committee-response` | Input is thesis committee feedback after a proposal or thesis defense, not a journal decision | Committee comments (written or from defense notes), defense type, revised page numbers or placeholders | Single committee response table (委員／意見／修改內容／頁碼) plus thesis change list; no reviewer-isolation filter; see `references/thesis-committee-response.md` |
| `committee-response` | Input is thesis committee feedback after a proposal or thesis defense, not a journal decision | Committee comments (written or from defense notes), defense type, revised page numbers or placeholders | Single committee response table (委員／意見／修改內容／頁碼) plus thesis change list; no reviewer-isolation filter; see `references/thesis-committee-response.md` |
...
- Thesis committee feedback after a proposal or thesis defense (口試委員意見) -> `committee-response`.
- Thesis committee feedback after a proposal or thesis defense (口試委員意見) -> `committee-response`.
