...
This is **writing guidance, not an official journal requirement**. Its
functional model is informed in part by *Science Research Writing for
Non-native Speakers of English* (Glasman-Deal). The rules below are a
selective, accuracy-checked synthesis rather than a transcription of that book.
For nursing and health-science manuscripts, apply the design-specific reporting
guideline (see `health-research-compliance.md`) before this file when the two
conflict.
