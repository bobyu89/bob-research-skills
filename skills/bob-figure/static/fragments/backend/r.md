...
library(ggplot2)
library(patchwork)
source("skills/bob-figure/scripts/panel_alignment.R")
...
- `references/nature-2026-observations.md` — Nature-family page archetypes; open only when the user explicitly targets such a journal.
