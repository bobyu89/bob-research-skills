...
3. choice already established in this task, then saved preference from `scripts/bob_figure_backend.py get`;
...
`scripts/bob_figure_backend.py set python` or `scripts/bob_figure_backend.py set r`.
