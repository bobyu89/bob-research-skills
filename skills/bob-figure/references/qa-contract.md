...
```bash
# Python source
python skills/bob-figure/scripts/validate_figure.py path/to/figure.py

# R, R Markdown, or Quarto source
python skills/bob-figure/scripts/validate_figure.py path/to/figure.R

# Machine-readable report or stricter warning gate
python skills/bob-figure/scripts/validate_figure.py path/to/figure.py --json
python skills/bob-figure/scripts/validate_figure.py path/to/figure.py --strict

# Exported-PDF glyph-size audit
python skills/bob-figure/scripts/audit_pdf_text.py path/to/figure.pdf --min-pt 5
python skills/bob-figure/scripts/audit_pdf_text.py path/to/figure.pdf --min-pt 5 --json

# Backend-neutral audit of the render-time Python/R panel-layout manifest
python skills/bob-figure/scripts/audit_panel_alignment.py path/to/figure.alignment-layout.json \
...
python skills/bob-figure/scripts/audit_figure_collisions.py path/to/figure.pdf \
...
python skills/bob-figure/scripts/audit_figure_collisions.py path/to/figure.pdf --strict
```
